...
The web font files in this directory are redistributed under the SIL Open Font
License, Version 1.1.

## Fraunces

- File: `fraunces-latin-wght-normal.woff2`
- Source package: `@fontsource-variable/fraunces`
- Copyright: Copyright 2020 The Fraunces Project Authors
...
- Files:
  - `karla-latin-400-normal.woff2`
  - `karla-latin-500-normal.woff2`
  - `karla-latin-600-normal.woff2`
- Source package: `@fontsource/karla`
...
This license is also available at:
